        ...
        <div class="flex gap-8">
          ...
          <div class="flex-1">
            <div class="flex items-center justify-between mb-6">
              <h1 class="text-xl font-semibold text-gray-900">Pending Loans</h1>
              <button
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">{{ loan.branchName }} • {{ loan.productName }}</p>
                      </div>
              ...
              <div class="bg-white rounded-xl border border-gray-100 p-6 sticky top-8">
                ...
                <div class="space-y-3 text-sm">
                  <div class="flex justify-between">
                    ...
                    <span class="text-gray-900">{{ selectedLoan()!.customerName }}</span>
                  </div>
                  <div class="flex justify-between">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="text-gray-900">{{ selectedLoan()!.productName }}</span>
                  </div>
                  <div class="flex justify-between">
                  ...
                  <div class="mt-6 pt-6 border-t border-gray-100">
                    ...
                    <div class="space-y-2">
                      @for (h of history(); track h.id) {
                        <div class="text-xs">
                          <p class="text-gray-900">{{ h.status }}</p>
                          <p class="text-gray-400">{{ h.approvedBy }} - {{ h.approvedByRole }}</p>
                        </div>
                      }
                    </div>
                  </div>
